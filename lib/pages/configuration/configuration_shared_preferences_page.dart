...
class ConfigurationSharedPreferencesPage extends StatefulWidget {
  const ConfigurationSharedPreferencesPage({super.key});

  @override
  State<ConfigurationSharedPreferencesPage> createState() => _ConfigurationSharedPreferencesPageState();
}

class _ConfigurationSharedPreferencesPageState extends State<ConfigurationSharedPreferencesPage> {
